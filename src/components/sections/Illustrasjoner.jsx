      ...
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4">
          ...
          <img
            src={pfp}
            alt="profilbilde"
            className="w-32 rounded-full mx-auto hover:-translate-y-1 transition"
          />
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            <p className="text-gray-300 mb-6">
              Mitt navn er Cecilia og jeg har lang erfaring fra apotekbransjen
              der jeg har opparbeidet meg god erfaring innen kundeservice. Tok
              ...
              jobbe som skribent og designer på fulltid, og erfaringen styrket
              min interesse for feltet. Da jeg senere gikk tilbake til
              apotekarbeid, innså jeg at det var design jeg virkelig ønsket å
              satse på.
            </p>
            <br />
            <p>
              Er nå 3.årsstudent i informasjonsteknologi på Oslomet og jobber
              deltid i apotek. Søker etter jobber der jeg kan utfolde meg i
              skjæringspunktet mellom utvikling og design.
            </p>

            <h3 className="font-bold mb-8 mt-8 text-[#fec588]">
              Utvalgte IT-kunnskaper:
            </h3>
            ...
            <div className="space-y-4 text-gray-300">
              ...
              <div className="border border-white/50 m-3 p-2">
                ...
                <p class="text-pink-200">
                  Grafisk design for nettside og trykkmateriell.
                </p>
              </div>
              ...
              <div className="border border-white/50 m-3 p-2">
                ...
                <p class="text-pink-200">
                  Resepthåndtering og kundeveiledning. Kampanjeansvarlig.
                </p>
              </div>
              ...
              <div className="border border-white/50 m-3 p-2">
                ...
                <p class="text-pink-200">
                  Utlånt til Apotek 1 Arkaden & Apotek 1 Paleet
                </p>
              </div>
              ...
              <div className="border border-white/50 m-3 p-2">
                ...
                <p class="text-pink-200">
                  Salg av billetter for sightseeingbuss
                </p>
              </div>
            </div>
          </div>
