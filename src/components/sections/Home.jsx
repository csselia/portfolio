      ...
      <RevealOnScroll>
        ...
        leading-tight"
          ...
          <div className="flex justify-center space-x-4">
            <a
              href="#projects"
              className="bg-[#d65f33] text-white py-3 px-6 rounded font-medium 
            ...
            <a
              href="#contact"
              className="border-pink-500/50 text-[#f08614] py-3 px-6 rounded font-medium transition-all
             duration-200
            hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(219,121,85,0.5)] hover:bg-pink-500/10"
            >
              Kontakt meg
            </a>
          </div>
