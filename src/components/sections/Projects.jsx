  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-4">
        <h2
          className="text-3xl font-bold mb-8 bg-gradient-to-r  from-violet-600 to-pink-500
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              Deltok på "Build an App in a Weekend" arrangert av KPMG og
              ServiceNow. Casen vi valgte var å utvikle en applikasjon som
              bruker en AI-agent til å automatisere manuelt skjemaarbeid for
              saksbehandlere hos Direktoratet for strålevern og atomsikkerhet
              (DSA). I forkant av prosjektet gjennomgikk vi 3 webinarer om
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              ...
              <a
                href="https://saveocean.net/oceanquest/"
                className="text-[#e73aa7] hover:text-[#fec588]"
              >
                {" "}
                OceanQuest,{" "}
              </a>
              som skal bidra til å lære alle interesserte om havet og
              bærekraftig havvern. Mine oppgaver i dette prosjektet var
              utvikling av prototyper i Figma og koding i frontend med React og
              Typescript.
              <div className="grid grid-cols-1 mt-7 gap-6">
                <img
                  src={afd_24}
          ...
          >
            <h3 className="text-xl font-bold mb-2">
              Nettside for S7vende hårstudio
            </h3>
            <p className="text-gray-400 mb-4">
              Praktisk IT-prosjekt (Vår 2025) utført sammen med medstudentene
              <a
                href="https://www.linkedin.com/in/fridavhaf/"
                className="text-[#e73aa7] hover:text-[#fec588]"
              >
                {" "}
                Frida
              ...
              og
              <a
                href="https://www.linkedin.com/in/sapphire-g-7295a5292/"
                className="text-[#e73aa7] hover:text-[#fec588]"
              >
                {" "}
                Sapphire.
              ...
              <p>
                Utviklet en nettside for en nyetablert frisørsalong,
                <a
                  href="https://syvendeharstudio.no/"
                  className="text-[#e73aa7] hover:text-[#fec588]"
                >
                  {" "}
                  S7vende hårstudio.
              ...
              <p>
                Lenke til{" "}
                <a
                  href="https://github.com/ehtaxhair/Project-Cutting-Edge-"
                  className="text-[#e73aa7]"
                >
                  Github-repo
                </a>
              </p>
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              Regnespill for barn i første klasse. Applikasjonen er utviklet i
              Kotlin med Jetpack Compose, og har som mål å gjøre læring av
              matematikk morsomt og engasjerende for barn.{" "}
            </p>
            <p>
              Lenke til{" "}
              <a
                href="https://github.com/csselia/AlvinMattespill"
                className="text-[#e73aa7]"
              >
                Github-repo
              </a>
            ...
            <div className="grid grid-cols-3 mt-7 gap-1">
              <img
                src={afd_15}
                alt="hovedbilde"
                className="w-50 rounded-2xl mx-auto hover:-translate-y-1 transition"
              />
              <img
                src={afd_15_1}
                alt="regnevindu"
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            ...
            >
              ...
              <p className="text-gray-400 mb-4">
                ...
                og
                <a
                  href="https://no.linkedin.com/in/jarle-kirkeby-614243380"
                  className="text-[#e73aa7] hover:text-[#fec588]"
                >
                  {" "}
                  Jarle
                ...
                <p className="text-gray-400 mb-4">
                  Her kan barn spille gjennom eventyr og lage sine egne
                  fortellinger. I dette prosjektet jobbet jeg med frontend
                  (React, Typescript, Tailwind CSS).
                </p>
                <p>
                  Lenke til{" "}
                  <a
                    href="https://github.com/Fridavhaf/Fairytailors-Fullstack"
                    className="text-[#e73aa7]"
                  >
                    Github-repo
                  </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            ...
            >
              <h3 className="text-xl font-bold mb-2">
                Webapplikasjon for glemt p-pille av merket Mercilon
              </h3>
              <p className="text-gray-400 mb-4">
                <p className="text-gray-400 mb-4">
                ...
                <div className="grid grid-cols-1 mt-7 gap-6">
                  <img
                    src={afd_21}
                    alt="diagrammer"
                    className="rounded-2xl mx-auto hover:-translate-y-1 transition"
                  />
                </div>
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            <div
              className="p-6 rounded-xl border border-white/50 hover:-translate-y-1
                hover:shadow-[0_2px_8px_rgba(59,130,2246, 0.1)] transition-all"
            >
              <h3 className="text-xl font-bold mb-2">Systemutvikling</h3>
              <p className="text-gray-400 mb-4">
                <p className="text-gray-400 mb-4">
                  Ulike diagrammer tegnet under faget Systemutvikling
                </p>
                <div className="grid grid-cols-1 mt-7 gap-6">
                  <img
                    src={afd_20}
          ...
          >
            <h3 className="text-xl font-bold mb-2">
              Utvalg av noen illustrasjoner for Apotek For Deg
            </h3>
            <p className="text-gray-400 mb-4">
              Utarbeidet illustrasjoner som skulle være tiltalende, informative
              og formidle positivitet.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
              ...
              <img
                src={afd_3}
                alt="informasjon til alle kunder"
                className="w-400 rounded-2xl mx-auto hover:-translate-y-1 transition"
              />
              <img
                src={afd_2}
                alt="pakke og levering"
                className="w-400 rounded-2xl mx-auto hover:-translate-y-1 transition"
              />
              <img
                src={afd_4}
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              Utarbeidet forslag på logoer til et mentolprodukt, samt logo for
              et bryllup.
            </p>
