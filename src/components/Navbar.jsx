...
export const Navbar = ({ menuOpen, setMenuOpen }) => {
  useEffect(() => {
    {
      /* Hvis menyen er åpen skal ikonet være skjult. Sjekker hver gang verdien endrer seg*/
    }
    ...
    >
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          <a
            href="#home"
            className="font-mono text-xl font-bold text-white hover:text-[#9d3ae4]"
          >
            CSSELIA
          </a>{" "}
          {/*Logo skal være her*/}
          {!menuOpen && (
            <div
              className="w-20 h-10 relative cursor-pointer z-40 md:hidden text-4xl"
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#home"
              className="text-gray-300 hover:text-[#e73aa7] transition-colors"
            >
              Hjem
            </a>
            <a
